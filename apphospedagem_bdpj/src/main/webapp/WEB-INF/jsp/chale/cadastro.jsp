...
<body>
	...
	<div class="container mt-3">
		<h2>Cadastro de Chále</h2>

		<form action="/chale/incluir" method="post">
			...
			<div class="mb-3 mt-3">
				<label for="codigo">Tipo Local:</label> <input type="text"
					class="form-control" value="Chalé" id="codTipoLocal"
