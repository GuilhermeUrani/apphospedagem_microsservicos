...
public class LocalImovelController {
	...
	@Operation(summary = "Método de listar locais de imoveis")
	...
	@Operation(summary = "Método de cadastrar local de imoveil")
	...
	@Operation(summary = "Método de excluir local de imoveil")
	...
	@Operation(summary = "Método de alterar local de imoveil")
